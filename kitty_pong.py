...
SCORE_FONT = pygame.font.Font('Assets\ibm3270.otf', 50, bold=True)
TITLE_FONT = pygame.font.Font('Assets\ibm3270.otf', 70, bold=True)
LEGEND_FONT = pygame.font.Font('Assets\ibm3270.otf', 50, bold=True)
WINNING_SCORE = 5
...
def main():
    ...
    intro_text = TITLE_FONT.render('K I T T Y P O N G', 1, "green")
    ...
    guide_left_player_nl = SCORE_FONT.render('WS', 1, 'green')
    guide_right_player_nl = SCORE_FONT.render('            ↑↓', 1, 'green')
    rules_text = SCORE_FONT.render('SCORE 5 POINTS', 1, 'green')
    rules_text_nl = SCORE_FONT.render('TO WIN', 1, 'green')
    ...
    WIN.blit(guide_right_player, (920, 40 - legend_text.get_height()//2))
    WIN.blit(guide_left_player_nl, (10, 80 - legend_text.get_height()//2))
    WIN.blit(guide_right_player_nl, (900, 80 - legend_text.get_height()//2))
    WIN.blit(rules_text, (WIDTH//2 - rules_text.get_width() //
             2, 40 - rules_text.get_height()//2))
    WIN.blit(rules_text_nl, (WIDTH//2 - rules_text_nl.get_width() //
             2, 80 - rules_text.get_height()//2))
    pygame.display.update()
